...
function Bendpoints(injector, eventBus, canvas, interactionEvents, bendpointMove, bendpointParallelMove) {
  ...
  function getConnectionIntersection(waypoints, event) {
    ...
    if(intersection) {
      var wp0 = waypoints[intersection.index - 1],
          wp1 = waypoints[intersection.index];
...
Bendpoints.$inject = [ 'injector', 'eventBus', 'canvas', 'interactionEvents', 'bendpointMove', 'bendpointParallelMove' ];
